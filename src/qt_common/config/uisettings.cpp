...
const std::array<Shortcut, 34> default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Open OpenPak")).toStdString(),               QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string(""),        std::string("Home+X"), Qt::WindowShortcut, false}},
